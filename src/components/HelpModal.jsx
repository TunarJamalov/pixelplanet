...
const HelpModal = () => (
  <Modal title="Welcome to pixelking.fun">
    <p style={{ textAlign: 'center' }}>
      ...
      Have fun!</p>
      <p>Discord: <a href="./discord" target="_blank">pixelking.fun/discord</a></p>
      <p>Source on <a href="https://github.com/pixelkingdev/pixelking" target="_blank">github</a></p>
      <p>Reddit: <a href="https://www.reddit.com/r/pixelkingFun/" target="_blank">r/pixelkingFun</a></p>
      <p>Image Converter: <a href="./convert" target="_blank">pixelking.fun/convert</a></p>
      <p>Image Converter for 2nd Planet: <a href="./convert2" target="_blank">pixelking.fun/convert2</a></p>
      ...
      <p style={textStyle}>The bare map data that we use, together with converted OpenStreetMap tiles for orientation,
        can be downloaded from mega.nz here: <a href="https://mega.nz/#!JpkBwAbJ!EnSLlZmKv3kEBE0HDhakTgAZZycD3ELjduajJxPGaXo">pixelkingmap.zip</a> (422MB)</p>
      ...
      <p style={textStyle}>If you got detected as proxy, but you are none, please send us an e-mail with <a href="https://www.whatismyip.com/">your IP</a> to pixelkingdev@gmail.com. Do not post your IP anywhere else. We are sorry for the inconvenience.</p>
